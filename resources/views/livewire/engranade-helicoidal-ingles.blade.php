...
<input type='hidden' name='kv1' value='<?php echo "$kv";?>'/> 
...
<input type='hidden' name='interpolar' value='<?php echo "$interpolar";?>'/> 
...
<input type='hidden' name='opcionflexion' value='<?php echo "$opcionflexion";?>'/> 
...
<input type='hidden' name='opcionflexionpinona' value='<?php echo "$opcionflexionpinona";?>'/> 
...
<input type='hidden' name='zn3' value='<?php echo "$zn3";?>'/> 
