            ...
            <main class="w-3/4 grid grid-cols-4 text-sm gap-y-1">
                ...
                {{-- Calidad para engranajes Qv --}}
                    <div class="flex flex-col items-center">
                            ...
                            <select class="mb-2 block w-36 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="calidad">
                ...
                {{-- Potencia a Transmitir HP --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="potencia">
                    </div>
                {{-- GRADOS --}}
                    <div class="flex flex-col items-center">
                        <label for="">Seleccione los Grados <b>(O)</b></label>
                            <select class="mb-2 block w-36 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="grados">
                                    <option class="text-gray-400" value="0">Seleccionar</option>
                ...
                {{-- # DE DienteS del piñon NP  --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="numpinon">
                    </div> 
                ...
                {{-- Dureza-Brinell Corona HBc --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="hbc">
                    </div> 
                {{-- RPM DEL PIÑON NP --}}
                    <div class="flex flex-col items-center">
                        <x-jet-label for="text" value="" />
                ...
                {{-- RPM DE LA CORONA NC --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="nc">
                    </div> 
                {{-- NUMERO DE CICLOS M --}}
                    <div class="flex flex-col items-center">
                        <x-jet-label for="text" value="" />
                ...
                {{-- REALCION DE TRANSMISION i = MG --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="transmision">
                    </div>  
                {{-- PASO DIAMETRAL PD --}} 
                    <div class="flex flex-col items-center">
                ...
                {{-- DIAMETRO DEL PIÑON DP --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="diametropinon">
                ...
                {{-- VELOCIDAD --}}
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="velocidad">
                            @php
                                if ($np && $diametropinon) {
                ...
                {{-- WT --}}
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="wt">
                            @php
                ...
                {{-- ST --}}
                    <div class="flex flex-col items-center">
                        <label for="">Resistencia a la Flexion <b>(St)</b></label>
                        <div class="flex">
                            <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="st">
                                {{number_format($st,3)}}
                            </span>
                ...
                {{-- ESFUERZO DE FLEXION O --}}
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="o">
                            @php
                            if ($ns && $st) {
                                $o = ($st)/(2*$ns);
                            }
                ...
                {{-- CALCULO DE P --}}
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="p">
                            @php
                            if ($pd) {
                                $p = pi()/$pd;
                            }
                ...
                {{-- KV 1 --}}
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="kv1">
                            {{number_format($kv1,3)}}
                        </span>
                    </div>
                {{-- CALCULO DE KS --}}
                ...
                {{-- KS --}}
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="ks">
                            {{number_format($ks,3)}}
                        </span>    
                    </div>
                {{-- CMC --}}
                ...
                {{-- CPF --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="cpf">
                            {{number_format($cpf,3)}}
                        </span>
                    </div>
                {{-- CPM --}}
                ...
                {{-- CMA A --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="a1">
                    </div>
                {{-- CMA B --}}
                    <div class="flex flex-col items-center">
                        <label for="">Cma <b>(B)</b></label>
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="b1">
                    </div>
                {{-- CMA C --}}
                    <div class="flex flex-col items-center">
                        <label for="">Cma <b>(C)</b></label>
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="c1">
                    </div>
                {{-- CALCULO Y RESULTADO CMA --}}
                    <div class="flex flex-col items-center">
                        <label for="">Cma <b>(Cma)</b></label>
                        <div class="flex">
                            <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="cma">
                                @php
                                    if ($a1 && $b1 && $c1 && $fn) {
                ...
                {{-- KM --}}
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="km">
                            {{number_format($km,3)}}
                        </span>
                    </div>
                {{-- MB --}}
                ...
                {{-- CALCULO DEL FACTOR DE SEGURIDAD YNP --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="ynp">
                    </div>
                {{-- KT --}}
                    <div class="flex flex-col items-center">
                        <label for="">KT <b>(Kt)</b></label>
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="kt">
                    </div>
                {{-- KR --}}
                    <div class="flex flex-col items-center">
                        <label for="">KR <b>(Kr)</b></label>
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="kr">
                    </div>
                {{-- SFP --}}
                    <div class="flex flex-col items-center">
                ...
                {{-- RESISTENCIA A LA FLEXION DEL CORONA STC --}}
                    <div class="flex flex-col items-center">
                        <label for="">Resistencia a la Flexion (Corona)<b>(Stc)</b></label>
                        <div class="flex">
                            <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="stc">
                                {{number_format($stc,3)}}
                            </span>
                            <a class="h-10 w-10 ml-2 text-yellow-600 bg-neutral-800 rounded-lg flex justify-center items-center" data-fancybox href="{{ asset('fotos/espoch.png') }}">
                                <i class="text-3xl  fa-solid fa-image"></i>
                ...
                {{-- YNC PARA LA CORONA --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="ync">
                    </div>
                ...
                {{-- CP PARA EL PINON --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="cp3">
                    </div>
                {{-- CF PARA EL PINON --}}
                    <div class="flex flex-col items-center">
                        <label for="">Cf <b>(Cf)</b></label>
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="cf3">
                    </div>
                {{-- FACTOR GEOMETRICO I --}}
                    <div class="flex flex-col">
                ...
                {{-- CALCULO FACTOR GEOMETRICO --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="i3">
                            {{number_format($i3,3)}}
                        </span>
                    </div>
                {{-- ESFUERZO DE CONTACTO DEL PIÑON ODP --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="odp">
                            {{number_format($odp,3)}}
                        </span>
                    </div>
                {{-- NUMERO DE ESFUERZO DE CONTACTO PERMISIBLE Sc --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="$sc3">
                            {{number_format($sc3,3)}}
                        </span>
                    </div>
                {{-- CHP PARA EL PINON --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="chp3">
                    </div>
                {{-- ZN PARA EL PINON --}}
                    <div class="flex flex-col items-center">
                        <label for="">ZN PIÑON<b>(Zn)</b></label>
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="zn3">
                    </div>
                {{-- CALCULO PORA EL SH DEL PIÑON --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="shp3">
                ...
                {{-- NUMERO DE ESFUERZO DE CONTACTO PERMISIBLE de la corona Sc --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="scc3">
                ...
                {{-- ZN PARA LA CORONA --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="znc3">
                    </div>
                {{-- CHC PARA EL CORONA --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="$chc3">
                ...
                {{-- CALCULO PORA EL SH DE LA CORONA --}}
                    <div class="flex flex-col items-center">
                        ...
                        @endphp
                        <span class="mb-2 w-36 h-10 flex justify-center items-center border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" wire:model="shc3">
