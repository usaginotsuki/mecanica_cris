<div class="p-6 h-auto bg-white rounded-lg text-neutral-600">
            ...
            <main class="w-3/4 grid grid-cols-4 text-sm gap-y-1">
                ...
                {{-- # DE DienteS del piñon NP  --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" step=".0000000000001" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" name="numpinon" wire:model="numpinon">
                    </div> 
                ...
                {{-- RPM DE LA CORONA NC --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" step=".0000000000001" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" name="nc" wire:model="nc">
                    </div> 
                {{-- NUMERO DE CICLOS M --}}
                    <div class="flex flex-col items-center">
                        <x-jet-label for="text" value="" />
                ...
                {{-- REALCION DE TRANSMISION i = MG --}}
                    <div class="flex flex-col items-center">
                        ...
                        <input type="number" step=".0000000000001" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" name="transmision" wire:model="transmision">
                    </div>  
                {{-- PASO DIAMETRAL PD --}} 
                    <div class="flex flex-col items-center">
                        <label for="">Paso Diametral <b>(Pd)</b></label>
                        <input type="number" step=".0000000000001" class="mb-2 block w-36  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm" name="pd" wire:model="pd">
                    </div>  
    ...
    <input type='hidden' name='diametropinon' value='<?php echo "$diametropinon";?>'/> 
    <input type='hidden' name='velocidad' value='<?php echo "$velocidad";?>'/> 
    ...
    <input type='hidden' name='kr' value='<?php echo "$kr";?>'/> 
    <input type='hidden' name='ync' value='<?php echo "$ync";?>'/> 
    <input type='hidden' name='sfc' value='<?php echo "$sfc";?>'/> 
    <input type='hidden' name='stc' value='<?php echo "$stc";?>'/> 
    <input type='hidden' name='cp3' value='<?php echo "$cp3";?>'/> 
    <input type='hidden' name='odp' value='<?php echo "$odp";?>'/> 
    <input type='hidden' name='cf3' value='<?php echo "$cf3";?>'/> 
    <input type='hidden' name='opcionfactorgeometrico' value='<?php echo "$opcionfactorgeometrico";?>'/> 
    <input type='hidden' name='shp3' value='<?php echo "$shp3";?>'/> 
    <input type='hidden' name='znc3' value='<?php echo "$znc3";?>'/> 
    <input type='hidden' name='chp3' value='<?php echo "$chp3";?>'/> 
    <input type='hidden' name='sc3' value='<?php echo "$sc3";?>'/> 
    <input type='hidden' name='shc3' value='<?php echo "$shc3";?>'/> 
    <input type='hidden' name='znc3' value='<?php echo "$znc3";?>'/> 
    <input type='hidden' name='scc3' value='<?php echo "$scc3";?>'/> 
    <input type='hidden' name='chc3' value='<?php echo "$chc3";?>'/> 
    <input type='hidden' name='numpinon' value='<?php echo "$numpinon";?>'/> 
