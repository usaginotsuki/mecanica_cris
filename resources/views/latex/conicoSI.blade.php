...
\doublespacing
   ...
   \begin{multicols}{2}
    ...
    $\upsigma_{Fpiñon}=\frac{1000*W^t}{b}*\frac{K_a*K_v}{m_{et}}*\frac{Y_x*K_{H\beta}}{Y_\beta*Y_{JP}}$\\
    $\upsigma_{Fpiñon} = $\\
    \\Ancho de cara\\
    $b=min[0.3A_o;\frac{10}{P_d}]$\\
    $A_0=\frac{d_p}{2Sen(\upvarphi)}$\\
    $b = $\\
    ...
    $S_F_p = n* \frac{\sigma_{FP_{piñon}}}{\sigma_{F_{piñon}}}$
    $S_F_p = $\\
